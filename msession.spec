...
Ten pakiet zawiera demona msession. Udostępnia on pseudo-bazodanowe
cache przechowywane w pamięci. Oryginalnie był projektowany w celu
współdzielenia danych przez wiele serwerów WWW.
...
Ten pakiet zawiera phoenix - bibliotekę zawierającą zbiór procedur
napisanych dla różnych projektów.
...
Pliki nagłówkowe biblioteki phoenix.
